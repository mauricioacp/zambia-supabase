...
VALUES (uuid_generate_v4(), 'general_director', 'Director General',
       ...
       (uuid_generate_v4(), 'communication_leader', 'Líder de Comunicación',
        'Lidera el equipo de comunicación, gestiona la estrategia de comunicación y la imagen corporativa', 'active', 80),
       (uuid_generate_v4(), 'executive_leader', 'Líder Ejecutivo',
        'Lidera el equipo ejecutivo, analiza necesidades de gestión y optimiza procesos internos', 'active', 90),
       (uuid_generate_v4(), 'community_leader', 'Líder de Komunidad',
        'Lidera el equipo de Komunidad, genera vínculos entre miembros actuales y antiguos de La Akademia', 'active', 80),
       (uuid_generate_v4(), 'coordination_leader', 'Líder de Koordinación',
        'Coordinador de todos los Koordinadores y su representante en el Konsejo', 'active', 80),
       (uuid_generate_v4(), 'coordinator', 'Koordinador',
        'Nexo entre el Konsejo y las Akademias locales asignadas. Apoyo y supervisión de sedes', 'active', 70),
       (uuid_generate_v4(), 'legal_advisor', 'Asesor Legal',
        'Lidera el Comité ético y asesora al Konsejo en temas legales', 'active', 80),
       (uuid_generate_v4(), 'konsejo_member', 'Miembro del Konsejo de Dirección',
        'Miembro del consejo de dirección con capacidad de toma de decisiones estratégicas', 'active', 70),
       ...
       (uuid_generate_v4(), 'superadmin', 'Super administrador', 'Administrador super usuario', 'active', 100),
       (uuid_generate_v4(), 'companion', 'Acompañante',
        'Persona que acompaña a los alumnos en su proceso de aprendizaje', 'active', 20),
       (uuid_generate_v4(), 'facilitator', 'Facilitador', 'Facilitador de actividades y talleres', 'active', 20),
       (uuid_generate_v4(), 'student', 'Alumno', 'Estudiante registrado en el programa', 'active', 1);
