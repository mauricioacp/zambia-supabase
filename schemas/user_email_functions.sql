-- Function to update user email in both auth.users and agreements table
-- This function is needed because the agreements table RLS policy prevents email updates
